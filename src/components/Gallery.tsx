...
const galleryCategories: GalleryCategory[] = [
  {
    ...
    images: [
      { src: "4b.jpg", alt: "Hackathon Winner", category: "coding" },
      { src: "sing.jpg", alt: "Code Workshop", category: "coding" },
      { src: "prize.jpg", alt: "Team Collaboration", category: "coding" },
      { src: "4a.jpg", alt: "Tech Conference", category: "coding" },
      { src: "ccpa.jpg", alt: "Pair Programming", category: "coding" },
      { src: "mans.jpg", alt: "Pair Programming", category: "coding" },
      { src: "code.jpg", alt: "Coding Competition", category: "coding" },
      { src: "slee.jpg", alt: "Team Collaboration", category: "coding" },
      { src: "flow1.jpg", alt: "Team Collaboration", category: "coding" },
      { src: "flow2.jpg", alt: "Team Collaboration", category: "coding" },
      { src: "bloom.jpg", alt: "Team Collaboration", category: "coding" },
  ...
  },
  {
    ...
    description: "Behind the scenes of my short films and editing work",
    images: [
      { src: "cin.jpg", alt: "Film Set", category: "filmmaking" },
      { src: "per.jpg", alt: "Camera Setup", category: "filmmaking" },
      { src: "edit.jpg", alt: "Directing", category: "filmmaking" },
      { src: "unknown.jpg", alt: "Post-Production", category: "filmmaking" },
      { src: "beauty.jpg", alt: "Location Scouting", category: "filmmaking" },
      { src: "yashu.jpg", alt: "Script Reading", category: "filmmaking" },
      { src: "dead.jpg", alt: "Script Reading", category: "filmmaking" },
    ]
  },
  {
    name: "Clubs",
